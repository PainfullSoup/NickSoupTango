...
moveStick = instance_create_layer(moveStickOriginX, joyStickOriginY, "Instances", oMoveStick)
lookStick = instance_create_layer(lookStickOriginX, joyStickOriginY, "Instances", oLookStick)
